...
class UserdetailsfetchTest extends TestCase
{
    /**
     ...
     * @return void
     */
    public function test_userfeatch_ristriction_present()
    {
    ...
    {
        $response = $this->json('get', '/api/auth/user-profile', [], ['Authorization' => $this->tokenvalid()]);
    ...
    {
        $response = $this->json('get', '/api/auth/user-profile', [], ['Authorization' => $this->tokeninvalid()]);
